            ...
            <nav>
                <div className="nav-wrapper black z-depth-3">
                    ...
                    <ul className="right hide-on-large-only">
                        ...
                        <li><a href="https://drive.google.com/file/d/1EGxcgCeX5JwdVODhA8utjJ10ZZQopUyX/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a></li>
                    </ul>
                    <ul className="right hide-on-med-and-down">
                        ...
                        >   
                            ...
                            <li>
                            <a href="https://drive.google.com/file/d/1EGxcgCeX5JwdVODhA8utjJ10ZZQopUyX/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="waves-effect waves-purple white-text">
                                Resume</a>
                            </li>
